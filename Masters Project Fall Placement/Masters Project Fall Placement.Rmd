...
In the case where *hsc_s* (Specialization in Higher Secondary Education) is NA, we also have NA for *salary*; this is not the case for when specialisation is NA.
