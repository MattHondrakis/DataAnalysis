...
The purpose of this case study is the dive into the data and find the differences between members and casuals, with the hopes of converting casuals to members. Members are individuals that by an annual subscription service, while casuals are individuals that buy single ride passes.
