...
Now, we will try to fit an ARIMA by looking at a stationary version of the time series. It appears as though the best fit in an ARIMA(2,1,3), although this is of course not the true model for the stock. ARIMA models are not great at modeling stock prices, as their prices are often a product of unknown variables.
